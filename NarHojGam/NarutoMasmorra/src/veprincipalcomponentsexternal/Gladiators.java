package veprincipalcomponentsexternal;
...
public class Gladiators {
	...
	public boolean GetterExtraTurn(){
	return _isextraturn;
	}
	public void SetterExtraTurn(boolean extraturn){
	 _isextraturn=extraturn;	
	}
	public int GetterLimitChakra(){
	 return _limitchakra;
	}
    public void SetterLimitChakra( int limitchakra){
     _limitchakra=limitchakra;
    }
